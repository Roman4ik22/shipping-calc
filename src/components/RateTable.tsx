          ...
          <div className="absolute left-0 mt-1 w-64 bg-card rounded-2xl shadow-2xl z-50 overflow-hidden">
            <div className="p-3">
              <input
                ...
                className="w-full px-3 py-2 text-sm bg-card-hover rounded-xl text-ink placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-accent/50"
                autoFocus
              />
            </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-1">
              <input
                ...
                className="w-24 px-4 py-3 bg-card-hover rounded-xl text-sm text-ink focus:outline-none focus:ring-2 focus:ring-accent/50 placeholder-gray-500"
              />
          ...
          <div className="mt-4 pt-4 border-t border-line">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-20 px-3 py-3 bg-card-hover rounded-xl text-sm text-ink focus:outline-none focus:ring-2 focus:ring-accent/50 placeholder-gray-600"
              />
