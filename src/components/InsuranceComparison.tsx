      ...
      <div className="flex gap-3 mb-4">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            placeholder="0"
            min="0"
            className="w-full pl-7 pr-3 py-2.5 bg-card-hover border border-line rounded-lg text-gray-100 placeholder-gray-500 focus:outline-none focus:border-accent/50"
          />
        </div>
