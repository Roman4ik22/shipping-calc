            ...
            <div className="flex flex-wrap gap-2">
              {relatedFrom.map((c) => (
                <Link
                  ...
                  className="bg-card hover:bg-card-hover rounded-lg px-3 py-2 transition-colors text-sm text-body hover:text-ink"
                >
              ...
              {popular
                ...
                .map((c) => (
                  <Link
                    ...
                    className="bg-surface hover:bg-card rounded-lg px-3 py-2 transition-colors text-sm text-body hover:text-ink"
                  >
                    {countryFlag(c.code)} {getCountryName(c, loc)}
                  </Link>
                ))}
