    ...
    <div>
      ...
      <RateTable
        ...
        labels={{
          ...
          no_rates_hint: t(loc, "no_rates_hint"),
          pick_another_country: t(loc, "pick_another_country"),
          browse_carriers_btn: t(loc, "browse_carriers_btn"),
          reset_filter: t(loc, "reset_filter"),
