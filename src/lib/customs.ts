...
const customsData: Record<string, CustomsInfo> = {
  ...
  CA: { currency: "CAD", de_minimis_usd: 20, vat_rate: 5, avg_duty_rate: 3.5, notes_en: "De minimis C$20 for duty, C$40 for tax. GST 5% + provincial taxes vary (HST up to 15%)", notes_ru: "Порог C$20 для пошлины, C$40 для налога. GST 5% + провинциальные налоги (HST до 15%)" },
  RU: { currency: "RUB", de_minimis_usd: 200, vat_rate: 20, avg_duty_rate: 15, notes_en: "Duty-free threshold €200 per parcel. Above: 15% duty but not less than €2/kg. EAEU rules apply", notes_ru: "Беспошлинный порог €200 за посылку. Свыше: 15% пошлина, но не менее €2/кг. Действуют правила ЕАЭС" },
  ...
  BR: { currency: "BRL", de_minimis_usd: 50, vat_rate: 17, avg_duty_rate: 60, notes_en: "Simplified tax of 60% for most goods + 17% ICMS. Remessa Conforme program: 20% tax for purchases up to $50 from registered platforms", notes_ru: "Упрощённый налог 60% на большинство товаров + 17% ICMS. Программа Remessa Conforme: 20% налог на покупки до $50 с зарегистрированных платформ" },
  MX: { currency: "MXN", de_minimis_usd: 50, vat_rate: 16, avg_duty_rate: 15 },
  TR: { currency: "TRY", de_minimis_usd: 0, vat_rate: 20, avg_duty_rate: 10, notes_en: "De minimis threshold eliminated in 2023. VAT and duties apply to all imports", notes_ru: "Порог де минимис отменён в 2023. НДС и пошлины применяются ко всему импорту" },
  ...
  KZ: { currency: "KZT", de_minimis_usd: 200, vat_rate: 12, avg_duty_rate: 15, notes_en: "EAEU member. Duty-free threshold €200 per parcel. Above: 15% duty but not less than €2/kg", notes_ru: "Член ЕАЭС. Беспошлинный порог €200 за посылку. Свыше: 15% пошлина, но не менее €2/кг" },
