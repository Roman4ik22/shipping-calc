...
const customsData: Record<string, CustomsInfo> = {
  US: { currency: "USD", de_minimis_usd: 0, vat_rate: 0, avg_duty_rate: 3.4, notes_en: "De minimis $800 exemption suspended since Aug 2025. All imports now subject to duties. No federal sales tax; state taxes may apply", notes_ru: "Освобождение де минимис $800 приостановлено с августа 2025. Все импортные товары облагаются пошлинами. Нет федерального налога; могут применяться налоги штата" },
  ...
  DE: { currency: "EUR", de_minimis_usd: 0, vat_rate: 19, avg_duty_rate: 4.2, notes_en: "EU customs union; EORI number may be required. From July 2026: €150 duty exemption removed, flat €3 duty on all low-value goods", notes_ru: "Таможенный союз ЕС; может потребоваться номер EORI. С июля 2026: отмена освобождения €150, единая пошлина €3 на все малоценные товары" },
  ...
  JP: { currency: "JPY", de_minimis_usd: 0, vat_rate: 10, avg_duty_rate: 4.5, notes_en: "De minimis abolished in 2026. 10% consumption tax applies to all imported goods regardless of value", notes_ru: "Порог де минимис отменён в 2026. 10% налог на потребление применяется ко всем импортным товарам независимо от стоимости" },
  KR: { currency: "KRW", de_minimis_usd: 150, vat_rate: 10, avg_duty_rate: 8 },
  AU: { currency: "AUD", de_minimis_usd: 700, vat_rate: 10, avg_duty_rate: 5, notes_en: "De minimis A$1000 (~$700 USD). GST 10% applies to all online purchases via vendor collection model", notes_ru: "Порог A$1000 (~$700 USD). GST 10% применяется ко всем онлайн-покупкам через модель сбора продавцом" },
  CA: { currency: "CAD", de_minimis_usd: 30, vat_rate: 5, avg_duty_rate: 3.5, notes_en: "De minimis C$40 for tax, C$150 for duty (CUSMA courier). GST 5% + provincial taxes vary (HST up to 15%)", notes_ru: "Порог C$40 для налога, C$150 для пошлины (CUSMA курьер). GST 5% + провинциальные налоги (HST до 15%)" },
  RU: { currency: "RUB", de_minimis_usd: 200, vat_rate: 22, avg_duty_rate: 15, notes_en: "VAT raised to 22% from Jan 2026. Duty-free threshold €200 per parcel (dropping to €100 in 2026, €50 in 2027). Above: 15% duty min €2/kg. EAEU rules", notes_ru: "НДС повышен до 22% с января 2026. Беспошлинный порог €200 за посылку (снижение до €100 в 2026, €50 в 2027). Свыше: 15% пошлина мин €2/кг. Правила ЕАЭС" },
  ...
  AE: { currency: "AED", de_minimis_usd: 82, vat_rate: 5, avg_duty_rate: 5, notes_en: "Dubai: AED 300 (~$82) threshold. Abu Dhabi: AED 1,000 (~$272). VAT 5% on all imports", notes_ru: "Дубай: порог AED 300 (~$82). Абу-Даби: AED 1,000 (~$272). НДС 5% на весь импорт" },
  ...
  BR: { currency: "BRL", de_minimis_usd: 0, vat_rate: 17, avg_duty_rate: 20, notes_en: "No de minimis since Aug 2024. Remessa Conforme: 20% duty on items up to $50, 60% duty on $50-$3000 (with $20 deduction). Plus 17% ICMS state tax on all imports", notes_ru: "Нет де минимис с августа 2024. Remessa Conforme: 20% пошлина на товары до $50, 60% на $50-$3000 (вычет $20). Плюс 17% ICMS на весь импорт" },
  MX: { currency: "MXN", de_minimis_usd: 50, vat_rate: 16, avg_duty_rate: 15 },
  TR: { currency: "TRY", de_minimis_usd: 0, vat_rate: 20, avg_duty_rate: 10, notes_en: "Simplified low-value customs system abolished Feb 2026. All overseas e-commerce goes through standard customs", notes_ru: "Упрощённая система для малоценных товаров отменена с февраля 2026. Весь зарубежный e-commerce проходит стандартную таможню" },
  ...
  ID: { currency: "IDR", de_minimis_usd: 3, vat_rate: 12, avg_duty_rate: 7.5, notes_en: "VAT nominally 12% since 2025 (effective ~11% via special calculation). Very low de minimis; duty applies to almost all imports", notes_ru: "НДС номинально 12% с 2025 (эффективно ~11% через специальный расчёт). Очень низкий порог; пошлина на почти весь импорт" },
  ...
  CH: { currency: "CHF", de_minimis_usd: 5, vat_rate: 8.1, avg_duty_rate: 2, notes_en: "VAT threshold CHF 5 on tax amount. Weight-based duties for many goods", notes_ru: "Порог НДС 5 CHF на сумму налога. Пошлины по весу для многих товаров" },
  ...
  UA: { currency: "UAH", de_minimis_usd: 150, vat_rate: 20, avg_duty_rate: 10, notes_en: "Duty-free threshold €150 per parcel. Above: 10% duty + 20% VAT. Some goods exempt during wartime", notes_ru: "Беспошлинный порог €150 за посылку. Свыше: 10% пошлина + 20% НДС. Некоторые товары освобождены в военное время" },
  KZ: { currency: "KZT", de_minimis_usd: 200, vat_rate: 16, avg_duty_rate: 15, notes_en: "EAEU member. VAT raised to 16% from Jan 2026. Duty-free threshold €200 per parcel. Above: 15% duty min €2/kg", notes_ru: "Член ЕАЭС. НДС повышен до 16% с января 2026. Беспошлинный порог €200 за посылку. Свыше: 15% пошлина мин €2/кг" },
  ...
  // Batch 5 — more countries
  AM: { currency: "AMD", de_minimis_usd: 200, vat_rate: 20, avg_duty_rate: 10, notes_en: "EAEU member. €200 duty-free threshold per parcel", notes_ru: "Член ЕАЭС. Беспошлинный порог €200 за посылку" },
  AZ: { currency: "AZN", de_minimis_usd: 30, vat_rate: 18, avg_duty_rate: 15 },
  UZ: { currency: "UZS", de_minimis_usd: 100, vat_rate: 12, avg_duty_rate: 20 },
  KG: { currency: "KGS", de_minimis_usd: 200, vat_rate: 12, avg_duty_rate: 15, notes_en: "EAEU member. €200 duty-free threshold per parcel", notes_ru: "Член ЕАЭС. Беспошлинный порог €200 за посылку" },
  TJ: { currency: "TJS", de_minimis_usd: 100, vat_rate: 15, avg_duty_rate: 15 },
  MD: { currency: "MDL", de_minimis_usd: 200, vat_rate: 20, avg_duty_rate: 10 },
  ME: { currency: "EUR", de_minimis_usd: 75, vat_rate: 21, avg_duty_rate: 10 },
  XK: { currency: "EUR", de_minimis_usd: 22, vat_rate: 18, avg_duty_rate: 10 },
  MN: { currency: "MNT", de_minimis_usd: 0, vat_rate: 10, avg_duty_rate: 5 },
  LA: { currency: "LAK", de_minimis_usd: 50, vat_rate: 10, avg_duty_rate: 10 },
  BN: { currency: "BND", de_minimis_usd: 400, vat_rate: 0, avg_duty_rate: 5, notes_en: "No VAT/GST. Low import duties", notes_ru: "Нет НДС. Низкие импортные пошлины" },
  CU: { currency: "CUP", de_minimis_usd: 0, vat_rate: 10, avg_duty_rate: 100, notes_en: "Very restrictive import rules; high duties on most goods", notes_ru: "Очень ограничительные правила импорта; высокие пошлины на большинство товаров" },
  JM: { currency: "JMD", de_minimis_usd: 50, vat_rate: 15, avg_duty_rate: 20 },
  TT: { currency: "TTD", de_minimis_usd: 50, vat_rate: 12.5, avg_duty_rate: 20 },
  HN: { currency: "HNL", de_minimis_usd: 0, vat_rate: 15, avg_duty_rate: 15 },
  SV: { currency: "USD", de_minimis_usd: 0, vat_rate: 13, avg_duty_rate: 15, notes_en: "Uses USD", notes_ru: "Используется USD" },
  NI: { currency: "NIO", de_minimis_usd: 0, vat_rate: 15, avg_duty_rate: 15 },
  MW: { currency: "MWK", de_minimis_usd: 0, vat_rate: 16.5, avg_duty_rate: 25 },
  ZM: { currency: "ZMW", de_minimis_usd: 0, vat_rate: 16, avg_duty_rate: 25 },
  ZW: { currency: "ZWL", de_minimis_usd: 0, vat_rate: 15, avg_duty_rate: 25 },
  AO: { currency: "AOA", de_minimis_usd: 0, vat_rate: 14, avg_duty_rate: 20 },
  MZ: { currency: "MZN", de_minimis_usd: 0, vat_rate: 16, avg_duty_rate: 20 },
  RW: { currency: "RWF", de_minimis_usd: 0, vat_rate: 18, avg_duty_rate: 25 },
  LY: { currency: "LYD", de_minimis_usd: 0, vat_rate: 0, avg_duty_rate: 5 },
  SD: { currency: "SDG", de_minimis_usd: 0, vat_rate: 17, avg_duty_rate: 25 },
  DZ: { currency: "DZD", de_minimis_usd: 0, vat_rate: 19, avg_duty_rate: 30, notes_en: "Very restrictive import policies; many goods banned", notes_ru: "Очень ограничительная импортная политика; много запрещённых товаров" },
  BW: { currency: "BWP", de_minimis_usd: 50, vat_rate: 14, avg_duty_rate: 10 },
  NA: { currency: "NAD", de_minimis_usd: 50, vat_rate: 15, avg_duty_rate: 10 },
  FJ: { currency: "FJD", de_minimis_usd: 200, vat_rate: 15, avg_duty_rate: 20 },
};
