...
const corridors: CorridorContent[] = [
  {
    ...
    to: "GB",
    trade_info_en:
      "The US and UK are major trade partners with bilateral goods trade exceeding $130 billion annually. There is no comprehensive free trade agreement between the two countries, so standard MFN tariffs apply. The UK charges 20% VAT on most imported goods with a de minimis threshold of GBP 135.",
    trade_info_ru:
